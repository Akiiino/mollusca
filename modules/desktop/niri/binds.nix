...
in
{
  programs.niri.settings.binds =
    ...
    in
    {
      ...
      "Mod+Shift+E" = {
        hotkey-overlay.title = "Power Menu (Fuzzel)";
      ...
      "Shift+XF86AudioRaiseVolume" = mkMediaBind [
        (lib.getExe' pkgs.swayosd "swayosd-client")
        "--output-volume"
        "+1"
      ];
      "Shift+XF86AudioLowerVolume" = mkMediaBind [
        (lib.getExe' pkgs.swayosd "swayosd-client")
        "--output-volume"
        "-1"
      ];
      ...
      "Shift+XF86MonBrightnessUp" = mkMediaBind [
        (lib.getExe' pkgs.swayosd "swayosd-client")
        "--brightness"
        "+1"
      ];
      "Shift+XF86MonBrightnessDown" = mkMediaBind [
        (lib.getExe' pkgs.swayosd "swayosd-client")
        "--brightness"
        "-1"
      ];

      "XF86AudioPlay" = mkMediaBind [
        (lib.getExe pkgs.playerctl)
        "play-pause"
      ];
      "XF86AudioPause" = mkMediaBind [
        (lib.getExe pkgs.playerctl)
        "pause"
      ];
      "XF86AudioNext" = mkMediaBind [
        (lib.getExe pkgs.playerctl)
        "next"
      ];
      "XF86AudioPrev" = mkMediaBind [
        (lib.getExe pkgs.playerctl)
        "previous"
      ];
      "XF86AudioStop" = mkMediaBind [
        (lib.getExe pkgs.playerctl)
        "stop"
      ];
